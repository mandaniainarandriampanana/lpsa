...
namespace Lpsa\AppBundle\Form\Type\NarrationPj;
...
class NarrationPjType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('file','lpsa_file',array(
                'label' => false,
                'display' => false,
                'route_name' => 'download_event_attachment',
                'required' => false,
                'constraints' => [
                    new File([
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Lpsa\AppBundle\Entity\NarrationPj'
        ));
    }
}
