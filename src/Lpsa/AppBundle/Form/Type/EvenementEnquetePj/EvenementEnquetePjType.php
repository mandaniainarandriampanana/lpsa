...
namespace Lpsa\AppBundle\Form\Type\EvenementEnquetePj;
...
class EvenementEnquetePjType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('file','lpsa_file',array(
                'label' => false,
                'display' => false,
                'route_name' => 'download_investigation_attachment',
                'required' => false,
                'constraints' => [
                    new File([
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Lpsa\AppBundle\Entity\EvenementEnquetePj'
        ));
    }
}
