 ...
 * ObjectifKpihse
 *
 * @ORM\Table(name="objectif_kpihse")
 * @ORM\Entity(repositoryClass="Lpsa\AppBundle\Repository\ObjectifKpihseRepository")
 */
class ObjectifKpihse
{
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_fat_lpsa", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_fat_contracte", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_fat_tiers", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_lti_lpsa", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_lti_contracte", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="rwc", type="integer", options={"default":0})
     */
    private $rwc = 0;
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_mt_lpsa", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_mt_contracte", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_fa_lpsa", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_fa_contracte", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="tri", type="integer", options={"default":0})
     */
    private $tri = 0;
     ...
     * @var text
     *
     * @ORM\Column(name="trir_12_mois", type="text", nullable=true)
     */
    private $trir12Mois;
     ...
     * @var text
     *
     * @ORM\Column(name="ltir_12_mois", type="text", nullable=true)
     */
    private $ltir12Mois;
     ...
     * @var text
     *
     * @ORM\Column(name="trir", type="text", nullable=true)
     */
    private $trir;
     ...
     * @var text
     *
     * @ORM\Column(name="ltir", type="text", nullable=true)
     */
    private $ltir;
     ...
     * @var text
     *
     * @ORM\Column(name="far", type="text", nullable=true)
     */
    private $far;
     ...
     * @var text
     *
     * @ORM\Column(name="far_12_mois", type="text", nullable=true)
     */
    private $far12Mois;
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_accident_depot_avec_arret", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_accident_transport_terrestre_avec_arret", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_lti_transport_terrestre_avec_arret", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_accident_transport_maritime_avec_arret", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_accident_siege_avec_arret", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_accident_depot_sans_arret", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_accident_transport_terrestre_sans_arret", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_lti_transport_terrestre_sans_arret", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_accident_transport_maritime_sans_arret", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_accident_siege_sans_arret", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_agression", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_vol", type="integer", options={"default":0})
     */
    private $nbreVol = 0;
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_intrusion", type="integer", options={"default":0})
     */
     ...
     * @var string
     *
     * @ORM\Column(name="nbre_jour_dernier_accident_corporel_route", type="decimal", precision=10, scale=2, options={"default":0})
     */
    private $nbreJourDernierAccidentCorporelRoute;

    /**
     * @var string
     *
     * @ORM\Column(name="km_dernier_accident_corporel_route", type="decimal", precision=10, scale=2, options={"default":0})
     */
    private $kmDernierAccidentCorporelRoute;

    /**
     * @var string
     *
     * @ORM\Column(name="nbre_jour_dernier_accident_corporel_rail", type="decimal", precision=10, scale=2, options={"default":0})
     */
    private $nbreJourDernierAccidentCorporelRail;

    /**
     * @var string
     *
     * @ORM\Column(name="km_dernier_accident_corporel_rail", type="decimal", precision=10, scale=2, options={"default":0})
     */
    private $kmDernierAccidentCorporelRail;

    /**
     * @var string
     *
     * @ORM\Column(name="nbre_jour_dernier_incident_maritime", type="decimal", precision=10, scale=2, options={"default":0})
     */
    private $nbreJourDernierIncidentMaritime;

    /**
     * @var string
     *
     * @ORM\Column(name="miles_dernier_incident_maritime", type="decimal", precision=10, scale=2, options={"default":0})
     */
    private $milesDernierIncidentMaritime;

    /**
     * @var string
     *
     * @ORM\Column(name="nbre_jour_dernier_fatalite", type="decimal", precision=10, scale=2, options={"default":0})
     */
    private $nbreJourDernierFatalite;

    /**
     * @var string
     *
     * @ORM\Column(name="taux_sinistralite", type="decimal", precision=10, scale=2, options={"default":0})
     */
    private $tauxSinistralite;

    /**
     * @var string
     *
     * @ORM\Column(name="km_vehicule_leger", type="decimal", precision=10, scale=2, options={"default":0})
     */
     ...
     * @var string
     *
     * @ORM\Column(name="taux_sinistralite_vehicule_leger", type="decimal", precision=10, scale=2, options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_exercice_poi", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_exercice_mini_poi", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_exercice_pum", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_exercice_combine", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_exercice_cmc", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="toolbox_siege", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="toolbox_depot", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="toolbox_sct", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_visite_codir", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_evenement_reporte", type="integer", options={"default":0})
     */
     ...
     * @var string
     *
     * @ORM\Column(name="indice_reporting", type="decimal", precision=10, scale=2, options={"default":0})
     */
    private $indiceReporting;

    /**
     * @var int
     *
     * @ORM\Column(name="nbre_presque_accident", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_acte_situation_dangereuse", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_incident_potentiel", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_analyse_arbre_cause_realise", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="zone_etanche_sup_159", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="zone_etanche_inf_159", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="zone_non_etanche_sup_159", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="zone_non_etanche_inf_159", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="fuite_produit_non_mesurable", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="pollution_marine", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="piezometre_nbre_echantillon_preleve", type="integer", options={"default":0})
     */
    private $piezometreNbEchantillonPreleve = 0;
    /**
     * @var int
     *
     * @ORM\Column(name="piezometre_nbre_echantillon_analyse", type="integer", options={"default":0})
     */
    private $piezometreNbEchantillonAnalyse = 0;
    /**
     * @var int
     *
     * @ORM\Column(name="piezometre_nbre_anomalie_releve", type="integer", options={"default":0})
     */
     ...
     * @var string
     *
     * @ORM\Column(name="piezometre_taux_non_conformite", type="decimal", precision=10, scale=2, options={"default":0})
     */
    private $piezometreTauxNonConformite;

    /**
     * @var int
     *
     * @ORM\Column(name="decanteur_nbre_echantillon_preleve", type="integer", options={"default":0})
     */
    private $decanteurNbEchantillonPreleve = 0;
    /**
     * @var int
     *
     * @ORM\Column(name="decanteur_nbre_echantillon_analyse", type="integer", options={"default":0})
     */
    private $decanteurNbEchantillonAnalyse = 0;
    /**
     * @var int
     *
     * @ORM\Column(name="decanteur_nbre_anomalie_releve", type="integer", options={"default":0})
     */
     ...
     * @var string
     *
     * @ORM\Column(name="decanteur_taux_non_conformite", type="decimal", precision=10, scale=2, options={"default":0})
     */
    private $decanteurTauxNonConformite;

    /**
     * @var int
     *
     * @ORM\Column(name="laboratoire_nbre_echantillon_preleve", type="integer", options={"default":0})
     */
    private $laboratoireNbEchantillonPreleve = 0;
    /**
     * @var int
     *
     * @ORM\Column(name="laboratoire_nbre_echantillon_analyse", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="laboratoire_nbre_anomalie_releve", type="integer", options={"default":0})
     */
     ...
     * @var string
     *
     * @ORM\Column(name="laboratoire_taux_non_conformite", type="decimal", precision=10, scale=2, options={"default":0})
     */
    private $laboratoireTauxNonConformite;

    /**
     * @var string
     *
     * @ORM\Column(name="laboratoire_resultat_essai_circulaire", type="decimal", precision=10, scale=2, options={"default":0})
     */
    private $laboratoireResultatEssaiCirculaire;

    /**
     * @var int
     *
     * @ORM\Column(name="nbre_non_conformite_cloture", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_non_conformite_non_echue", type="integer", options={"default":0})
     */
     ...
     * @var int
     *
     * @ORM\Column(name="nbre_overdue", type="integer", options={"default":0})
     */
     ...
     * @var string
     *
     * @ORM\Column(name="pourcentage_overdue", type="decimal", precision=10, scale=2, options={"default":0})
     */
